export const blogData = [
  ...
  // {
  //     id: 3,
  //     title: 'MAX FASHION an  Ecommerce website',
  //     description: 'The experience of the first project, with a focus on leadership skills',
  //     date: 'Jan 23, 2022',
  //     image: 'https://miro.medium.com/max/875/1*VNb0tcgKmYTYfVrLPCQLYg.png',
  //     url: 'https://medium.com/@keshavgaur053/the-story-of-cloning-an-ecommerce-db0ac5e521fa'
  // },
];
